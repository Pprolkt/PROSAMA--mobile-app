  ...
  return (
    <div className="job-detail">
      ...
      <div className="detail-grid">
        <div className="detail-main">
          ...
          <section className="detail-section">
            ...
            <p>
              You'll be embedded in a cross-functional squad alongside PMs, designers, and engineers shipping products used by millions.
            </p>
          </section>
        ...
        <aside className="detail-sidebar">
          ...
          <div className="sidebar-card company-card">
            ...
            <p>One of Australia's leading tech companies, trusted by millions. Known for a strong engineering culture and world-class benefits.</p>
      ...
      <style>{`
        ...
        .back-btn { background: none; border: none; color: var(--muted); font-size: 14px; font-weight: 500; margin-bottom: 28px; padding: 0; transition: color var(--transition); }
        ...
        .detail-logo { width: 64px; height: 64px; border-radius: 14px; background: var(--surface2); border: 1px solid var(--border); display: flex; align-items: center; justify-content: center; font-family: var(--font-head); font-weight: 800; font-size: 20px; color: var(--accent); flex-shrink: 0; }
        .urgent-badge { font-size: 12px; font-weight: 600; background: rgba(249,115,22,0.15); color: #f97316; padding: 4px 10px; border-radius: 20px; display: inline-block; margin-bottom: 8px; }
        .detail-title { font-family: var(--font-head); font-size: 28px; font-weight: 800; margin-bottom: 4px; }
        .detail-company { color: var(--muted); font-size: 16px; }
        .detail-chips { display: flex; flex-wrap: wrap; gap: 8px; margin-bottom: 16px; }
        .chip { font-size: 13px; padding: 6px 14px; background: var(--surface); border: 1px solid var(--border); border-radius: 20px; color: var(--muted); }
        .salary-chip { color: var(--success); border-color: rgba(34,197,94,0.3); background: rgba(34,197,94,0.08); }
        .detail-tags { display: flex; gap: 8px; flex-wrap: wrap; margin-bottom: 32px; }
        .tag { font-size: 12px; padding: 4px 12px; background: var(--surface2); border: 1px solid var(--border); border-radius: 20px; color: var(--accent); }
        .detail-section { margin-bottom: 32px; }
        .detail-section h2 { font-family: var(--font-head); font-size: 18px; font-weight: 700; margin-bottom: 14px; color: var(--text); }
        .detail-section p { color: var(--muted); line-height: 1.7; margin-bottom: 12px; font-size: 15px; }
        .resp-list { list-style: none; display: flex; flex-direction: column; gap: 10px; }
        .resp-list li { padding-left: 20px; position: relative; color: var(--muted); font-size: 15px; line-height: 1.6; }
        .resp-list li::before { content: '→'; position: absolute; left: 0; color: var(--accent); }
        .perks-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 10px; }
        .perk-card { background: var(--surface); border: 1px solid var(--border); border-radius: 8px; padding: 12px 16px; font-size: 14px; color: var(--muted); }
        .sidebar-card { background: var(--surface); border: 1px solid var(--border); border-radius: var(--radius); padding: 24px; margin-bottom: 16px; }
        .sidebar-salary { font-family: var(--font-head); font-size: 22px; font-weight: 800; color: var(--success); margin-bottom: 4px; }
        .sidebar-type { color: var(--muted); font-size: 13px; margin-bottom: 20px; }
        .apply-btn, .save-btn, .msg-btn { width: 100%; padding: 13px; border-radius: 10px; border: none; font-size: 15px; font-weight: 600; margin-bottom: 10px; transition: all var(--transition); }
        .apply-btn { background: var(--accent); color: white; }
        ...
        .save-btn { background: var(--surface2); border: 1px solid var(--border); color: var(--text); }
        .save-btn:hover { border-color: var(--accent); }
        .save-btn.saved { color: var(--accent); border-color: var(--accent); }
        .msg-btn { background: none; border: 1px solid var(--border); color: var(--muted); }
        .msg-btn:hover { border-color: var(--accent2); color: var(--text); }
        .company-card h3 { font-family: var(--font-head); font-size: 15px; font-weight: 700; margin-bottom: 10px; }
        .company-card p { color: var(--muted); font-size: 13px; line-height: 1.6; margin-bottom: 16px; }
        .company-stats { display: flex; gap: 20px; }
        .company-stats div { display: flex; flex-direction: column; gap: 2px; }
